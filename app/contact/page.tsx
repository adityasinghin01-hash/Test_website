        ...
        <div style={{ width: '100%', maxWidth: '600px' }}>
          ...
          {status === 'success' ? (
            <motion.div
              ...
              style={{
                ...glass, borderRadius: '24px', padding: '48px 32px', textAlign: 'center',
                border: '1px solid rgba(6,182,212,0.3)',
              }}
            >
              <motion.div
              ...
              <h2 style={{ fontSize: '28px', fontWeight: 800, color: '#f1f5f9', marginBottom: '8px' }}>Message Sent!</h2>
              <p style={{ color: '#475569', marginBottom: '24px' }}>We'll get back to you as soon as possible.</p>
              <button
            ...
            >
              ...
              <div>
                ...
                <input type="text" name="subject" value={formData.subject} onChange={handleChange} required placeholder="What's on your mind?" style={inputStyle} />
              </div>
              <div>
                <label style={{ display: 'flex', alignItems: 'center', gap: '6px', fontSize: '13px', color: '#475569', marginBottom: '8px', fontWeight: 500 }}>
                ...
                <textarea
                  ...
                  rows={6} placeholder="Tell us everything..."
